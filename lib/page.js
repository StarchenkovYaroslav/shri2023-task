...
function Header() {
  ...
  return React.createElement(
    ...
    React.createElement(
      "button",
      { className: "header__menu", "aria-expanded": expanded ? 'true' : 'false', onClick: onClick },
      React.createElement(
        "span",
...
function Event(props) {
  ...
  return React.createElement(
    "li",
    { ref: ref, className: 'event' + (props.slim ? ' event_slim' : '') },
    React.createElement(
      "button",
      { className: "event__button" },
      React.createElement("span", { className: `event__icon event__icon_${props.icon}`, role: "img", "aria-label": props.iconLabel }),
      React.createElement(
        "h4",
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "select",
          { className: "section__select", defaultValue: "all", onInput: onSelectInput },
          TABS_KEYS.map(key => React.createElement(
            "option",
            { key: key, value: key },
            TABS[key].title
          ))
      ...
      React.createElement(
        "div",
        { className: "section__panel-wrapper", ref: ref },
        TABS_KEYS.map(key => React.createElement(
          "div",
          { key: key, role: "tabpanel", className: 'section__panel' + (key === activeTab ? '' : ' section__panel_hidden'), "aria-hidden": key === activeTab ? 'false' : 'true', id: `panel_${key}`, "aria-labelledby": `tab_${key}` },
          React.createElement(
            "ul",
            { className: "section__panel-list" },
            TABS[key].items.map((item, index) => React.createElement(Event, _extends({
              key: index
            }, item, {
              onSize: onSize
            })))
        ...
        hasRightScroll && React.createElement("div", { className: "section__arrow", onClick: onArrowCLick })
      )
    )
  );
}
